...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Hydraboost_Elementor\Plugin The single instance of the class.
	 */
	 ...
	 * @access public
	 * @static
	 * @return \Hydraboost_Elementor\Plugin An instance of the class.
	 */
	...
	public function init() {
		...
		add_action( 'elementor/elements/categories_registered', [ $this, 'custom_category' ] );
	...
	// custom_category
	public function custom_category( $elements_manager ) {

		$elements_manager->add_category(
			'hydraboost-category',
			[
				'title' => esc_html__( 'Hydraboost Category', 'hydraboost-core' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/hydraboost-services.php' );
		require_once( __DIR__ . '/widgets/hydraboost-audio.php' );

		$widgets_manager->register( new \Hydraboost_Elementor\Hydraboost_Services() );
		$widgets_manager->register( new \Hydraboost_Elementor\Hydraboost_Audio() );
